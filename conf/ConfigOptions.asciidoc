...
** `hoot::RemoveEmptyReviewRelationsVisitor` - Remove empty review relations
...
If the name similarity score is greater than this then the names are considered a match. Scores

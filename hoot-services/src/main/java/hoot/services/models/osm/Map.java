...
public class Map extends Maps {
    ...
    public JSONObject retrieveNodesMBR(BoundingBox bounds) {
        ...
        if (!tileIdRanges.isEmpty()) {
            ...
            ret.put("maxlon", (maxLon == null) ? -180d : maxLon);
            ret.put("minlon", (minLon == null) ? -90d : minLon);
            ret.put("maxlat", (maxLat == null) ? 180d : maxLat);
            ret.put("minlat", (minLat == null) ? 90d : minLat);
        }
